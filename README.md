...
Si forma parte de la comunidad de Adobe y desea crear un artículo o enviar cambios importantes, envíe un problema en la ficha _Problemas_ para iniciar una conversación con el equipo de documentación. Una vez que usted y el escritor estén de acuerdo en un plan, cree y coloque el contenido juntos.

### Cambios importantes de los empleados de Adobe

Si es redactor técnico, administrador de programa o desarrollador de un equipo de producto de Adobe, y su trabajo consiste en colaborar en artículos técnicos o en crearlos, utilice el repositorio privado en `https://git.corp.adobe.com/AdobeDocs`.
