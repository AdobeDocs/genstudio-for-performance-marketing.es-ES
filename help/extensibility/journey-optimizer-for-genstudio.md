...
1. Agregue la API **Adobe Journey Optimizer (AJO)** al proyecto haciendo clic en **[!UICONTROL Agregar API]** y seleccionando **[!UICONTROL Adobe Journey Optimizer]** de la lista de API de producto **[!DNL CX Enterprise]**.
