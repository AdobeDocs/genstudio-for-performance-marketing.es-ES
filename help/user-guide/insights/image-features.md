...
| Ángulo de cámara | La perspectiva desde la que la cámara capta el sujeto, lo que afecta la percepción e interpretación de la imagen por parte del espectador. Si el estilo de la imagen es `photograph`, se identifica este rasgo. | `Low angle`, `High angle`, `Eye level`, `Overhead view`, `Dutch angle`, `Bird's eye view`<p>Ejemplo de `eye level`:<p>![nivel de vista](/help/assets/category/image-camera-angle.png "Personas sentadas en ángulos diferentes"){width="200" zoomable="yes"} |
| Ajuste de cámara | Los ajustes y configuraciones específicos de los controles de la cámara que influyen en el aspecto final y la calidad de la imagen. Si el estilo de la imagen es `photograph`, se identifica este rasgo. | `Fast shutter speed`, `Long exposure`, `Bokeh blur`, `Motion blur`, `Tilt-shift blur`, `Flash`, `Wide-angle`, `Black and white`, `Surreal`, `Double-exposure`, `Macro`, `Normal mode`<p>Ejemplo de configuración de `macro`:<p>![Primer plano de macro](/help/assets/category/image-subject-distance.png "Configuración de macro para flor de primer plano y abeja con joyas"){width="200" zoomable="yes"} |
...
| Distancia al sujeto | Distancia entre la cámara y el sujeto de una imagen. | `close up`, `mid shot`, `long shot`<p>Ejemplo de `closeup shot`:<p>![primer plano](/help/assets/category/image-subject-distance.png "Primer plano de flores y abejas con joyas"){width="200" zoomable="yes"} |
