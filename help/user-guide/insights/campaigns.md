...
La vista [!DNL Insights] _[!UICONTROL Campañas]_ muestra una lista de campañas para la cuenta de anuncios del canal conectado.

{{connect-insights}}

La tabla _[!UICONTROL Campañas]_ está organizada mediante la campaña de anuncios basada en el canal. Haga clic en el icono de configuración (cog) situado encima de la parte derecha de la tabla para alternar las columnas visibles.
...
| **[!UICONTROL CPC ]**<br>_Costo por clic_ | Costo promedio asociado con cada clic en una campaña de publicidad.<br>**Cálculo**: importe total `spent` dividido entre `clicks` = $ | Unos costes medios menores pueden indicar un gasto publicitario rentable, especialmente en comparación con un aumento de las conversiones. |
