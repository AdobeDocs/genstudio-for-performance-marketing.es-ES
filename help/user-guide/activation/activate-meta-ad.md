...
**Para conectar GenStudio for Performance Marketing con sus cuentas Meta**:

1. En _Configuración_, haga clic en **[!UICONTROL Conectar]** en el mosaico Meta Ads. Se abre la vista de la cuenta _Meta ads_.

1. Seleccione **[!UICONTROL Permitir elementos emergentes]** de su explorador, si se le solicita.

1. Seleccione una o más de sus cuentas de publicidad para conectarse y luego haga clic en **[!UICONTROL Seleccionar]**.
...
Utilice la sección _Texto_ de la página _Activar Meta ad_ para agregar texto atractivo y compatible con la marca a los campos de texto requeridos. Texto incluye el texto principal (cuerpo) del anuncio y el texto de la llamada a la acción.
...
_Solo GenStudio for Performance Marketing requiere texto principal_ y _titular_, no Meta.
...
### Activación completa de su experiencia publicitaria

Haga clic en **[!UICONTROL Publicar]**. La experiencia completa con anuncios Meta y sus metadatos asociados se insertan directamente en el conjunto de anuncios Meta Ads Manager seleccionado. Las experiencias se envían al administrador de metadatos de anuncios desactivado. Desde el administrador de Meta Ads, puede administrar los pasos finales de implementación de la experiencia publicitaria y la campaña de Meta.

### Inicie sesión en el administrador de Meta Ads para completar la activación

Una vez finalizada la activación, debe iniciar sesión en el Administrador de metadatos de anuncios. Desde [Meta Ads Manager](https://adsmanager.facebook.com/), puede revisar su experiencia publicitaria y finalizar la publicación en determinados canales Meta.
