...
[!DNL Activate] ahora admite la activación masiva: seleccione varias experiencias aprobadas de [!DNL Content] y publíquelas en varios canales de publicidad pagada en una sola tabla de activación, incluidos Meta, LinkedIn, Google Campaign Manager 360, Amazon Ads, Innovid, TikTok, YouTube, ChatGPT y Trade Desk. Edite los campos compartidos en línea o por lotes y, a continuación, publique todos los anuncios junto con el seguimiento del estado por anuncio y los reintentos automáticos en caso de error.

Obtenga más información en [Flujo de trabajo de activación](/help/user-guide/activation/create-activation.md).

## Notas de la versión anteriores

+++Notas a partir del 16 de julio de 2026
