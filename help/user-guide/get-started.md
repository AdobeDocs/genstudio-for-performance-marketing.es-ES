...
Configure una conexión entre GenStudio for Performance Marketing y las cuentas sociales de su organización para recibir datos de sus campañas de marketing, recursos y experiencias activos. [!DNL Insights] proporciona herramientas para analizar datos derivados del canal. Ver [Conectarse a Meta Ads](/help/user-guide/connectors/meta-ads.md).
